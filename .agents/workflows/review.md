...
- Use standard template from `.gemini/skills/file-todos/assets/todo-template.md`
...
2. Use file-todos skill for structured todo management:
   ...
   - Template location: `.gemini/skills/file-todos/assets/todo-template.md`
...
5. Follow template structure from file-todos skill: `.gemini/skills/file-todos/assets/todo-template.md`
