...
# 2. User's global skills (~/.gemini/)
ls ~/.gemini/skills/

# 3. compound-engineering plugin skills
ls ~/.gemini/plugins/cache/*/compound-engineering/*/skills/

# 4. ALL other installed plugins - check every plugin for skills
find ~/.gemini/plugins/cache -type d -name "skills" 2>/dev/null

# 5. Also check installed_plugins.json for all plugin locations
cat ~/.gemini/plugins/installed_plugins.json
```
...
**Example spawns:**
```
Task general-purpose: "Use the dhh-rails-style skill at ~/.gemini/plugins/.../dhh-rails-style. Read SKILL.md and apply it to: [Rails sections of plan]"

Task general-purpose: "Use the frontend-design skill at ~/.gemini/plugins/.../frontend-design. Read SKILL.md and apply it to: [UI sections of plan]"

Task general-purpose: "Use the agent-native-architecture skill at ~/.gemini/plugins/.../agent-native-architecture. Read SKILL.md and apply it to: [agent/tool sections of plan]"

Task general-purpose: "Use the security-patterns skill at ~/.gemini/skills/security-patterns. Read SKILL.md and apply it to: [full plan]"
```
...
find .gemini/docs -name "*.md" -type f 2>/dev/null
find ~/.gemini/docs -name "*.md" -type f 2>/dev/null
```
...
find .gemini/agents -name "*.md" 2>/dev/null

# 2. User's global agents (~/.gemini/)
find ~/.gemini/agents -name "*.md" 2>/dev/null

# 3. compound-engineering plugin agents (all subdirectories)
find ~/.gemini/plugins/cache/*/compound-engineering/*/agents -name "*.md" 2>/dev/null

# 4. ALL other installed plugins - check every plugin for agents
find ~/.gemini/plugins/cache -path "*/agents/*.md" 2>/dev/null
