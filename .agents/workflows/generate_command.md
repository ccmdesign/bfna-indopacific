...
Create a new slash command in `.gemini/commands/` for the requested task.
...
1. **Create the file** at `.gemini/commands/[name].md` (subdirectories like `workflows/` supported)
